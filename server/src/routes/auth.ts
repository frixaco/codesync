...
import { issueAccessToken, issueRefreshToken, verifyAccessToken, verifyRefreshToken } from "../helpers/jwt";
...
router.post("/login", async (req: TypedRequest<LoginReq>, res: TypedResponse<LoginRes>) => {
  try {
...
router.post("/signup", async (req: TypedRequest<SignupReq>, res: TypedResponse<SignupRes>) => {
  try {
